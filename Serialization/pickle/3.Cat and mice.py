...
test_mouse = Mouse()
print(test_mouse)
print(test_mouse.__getstate__())  #{'age': 14, 'weight': 148}


mouse_str = pickle.dumps(test_mouse)
print(mouse_str)

restored_mouse = pickle.loads(mouse_str)
...
with open("test_mouse.txt", "wb") as file:
    pickle.dump(test_mouse, file)
with open("test_mouse.txt", "rb") as file:
    mouse_from_file = pickle.load(file)
