# Наследование с переопределением атрибутов (метода __init__)
...
# Переопределение атрибута в наследуюемом классе.
# Эта часть кода необходима, чтобы добавить новый атрибут battery_power класс наследник.
    def __init__(self, make, model, year):
# метод __init__ получает инф-цию, необхд. для созд. экземпляра род. класса.
